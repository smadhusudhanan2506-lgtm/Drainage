...
export const COLORS = {
  ...
  particleNormal:   'rgba(160, 210, 255, 0.7)',

  // Danger state
  pipeDanger:       '#ef4444',
  pipeDangerGlow:   '#ff6b6b',
  sensorDanger:     '#dc2626',
  particleDanger:   'rgba(255, 100, 100, 0.8)',

  // Warning
  pipeWarning:      '#f59e0b',
  sensorWarning:    '#d97706',

  // Offline / Maintenance
  sensorOffline:    '#6b7280',
  sensorMaint:      '#a78bfa',

  // Backgrounds
  ugBackground:     '#0a1628',
  ugGrid:           'rgba(50, 100, 160, 0.08)',
  agBackground:     '#1a2744',
  agRoad:           '#4a5568',
  agBuilding:       '#2d3a4f',
  agPark:           '#1a4d2e',
  agLake:           '#1a4a6b',
  agResidential:    '#3d3528',
  agCommercial:     '#2d3548',
  agHospital:       '#3d2828',
  agGovernment:     '#2d3040',
  agMarket:         '#3d3228',
  agBusTerminal:    '#2d3535',

  // UI
  panelBg:          'rgba(15, 25, 50, 0.85)',
  panelBorder:      'rgba(100, 160, 220, 0.2)',
  textPrimary:      '#e2e8f0',
...
export const NODES = {
  ...
  'S-06':  { x: 540, y: 360, type: 'sensor',   label: 'S-06',  surface: '2nd Avenue (Central Segment)' },
  'MH-05': { x: 710, y: 360, type: 'manhole',  label: 'MH-05', surface: '2nd Avenue & East Blvd' },

  // ── Vertical · y = 485 ───────────────────────────────────
  'S-07':  { x: 370, y: 485, type: 'sensor',   label: 'S-07',  surface: 'Central Blvd (Mid Segment)' },
  'S-13':  { x: 710, y: 485, type: 'sensor',   label: 'S-13',  surface: 'East Blvd (Mid Segment)' },
  ...
  'S-09':  { x: 540, y: 600, type: 'sensor',   label: 'S-09',  surface: '3rd Avenue (Central Segment)' },
  'MH-08': { x: 710, y: 600, type: 'manhole',  label: 'MH-08', surface: '3rd Avenue & East Blvd' },
...
export const ZONES = [
  ...
  { id: 'east-res',        label: 'East Residential\nArea', x: 720, y: 385, w: 240, h: 190, type: 'residential' },
  ...
  { id: 'river',           label: 'River',                 x: 870, y: 790, w: 150, h: 120, type: 'river' },
];

/* ── Roads (above-ground map) ──────────────────────────────── */
export const ROADS = [
  // Horizontal roads
  { id: 'rd-h1', x1:  30, y1: 110, x2: 990, y2: 110, width: 32, label: '1st Avenue' },
  { id: 'rd-h2', x1:  30, y1: 360, x2: 760, y2: 360, width: 32, label: '2nd Avenue' },
  { id: 'rd-h3', x1:  30, y1: 600, x2: 760, y2: 600, width: 32, label: '3rd Avenue' },
  { id: 'rd-h4', x1:  30, y1: 820, x2: 990, y2: 820, width: 36, label: '4th Avenue (Main)' },
  // Vertical roads
  { id: 'rd-v1', x1: 370, y1:  50, x2: 370, y2: 870, width: 28, label: 'Central Blvd' },
  { id: 'rd-v2', x1: 710, y1: 110, x2: 710, y2: 820, width: 24, label: 'East Blvd' },
];

/* ── Sensor Thresholds ─────────────────────────────────────── */
export const THRESHOLDS = {
  flowRate: {
    normal:    { min: 0.3, max: 2.5 },   // m³/s
    warning:   { min: 0.1, max: 3.5 },
    critical:  { min: 0.0, max: 5.0 },
  },
  waterLevel: {
    normal:    { max: 0.6 },              // fraction of pipe diameter
    warning:   { max: 0.8 },
    critical:  { max: 0.95 },
  },
  velocity: {
    normal:    { min: 0.5, max: 3.0 },   // m/s
    stagnant:  { max: 0.1 },
  },
  battery: {
    low:       25,                         // percent
...
export const SEGMENT_STATES = {
  NORMAL:             'normal',
  ABNORMAL:           'abnormal',
  PROBABLE_BLOCKAGE:  'probable_blockage',
  CONFIRMED_BLOCKAGE: 'confirmed_blockage',
...
/* ── Historical Playback Scenario ──────────────────────────── */
export const PLAYBACK_SCENARIO = {
  title: 'Blockage Incident — 2nd Avenue Central Segment',
  duration: 45,   // seconds
  events: [
    { t:  0, type: 'status',  message: 'All systems normal' },
    { t:  5, type: 'anomaly', sensorId: 'S-06', field: 'waterLevel', value: 0.72, message: 'S-06 water level rising' },
    { t:  8, type: 'anomaly', sensorId: 'S-06', field: 'flowRate',   value: 0.18, message: 'S-06 flow rate dropping' },
    { t: 10, type: 'anomaly', sensorId: 'S-06', field: 'waterLevel', value: 0.85, message: 'S-06 water level warning' },
    { t: 12, type: 'anomaly', sensorId: 'J-02', field: 'flowRate',   value: 0.40, message: 'J-02 output flow reduced' },
    { t: 14, type: 'segment', pipeId: 'P11', state: 'abnormal',  message: 'Segment P11 (J-02→S-06) flagged abnormal' },
    { t: 16, type: 'segment', pipeId: 'P12', state: 'abnormal',  message: 'Segment P12 (S-06→MH-05) flagged abnormal' },
    { t: 18, type: 'alert',   severity: 'warning', segment: 'P11', confidence: 65, message: 'Probable blockage between J-02 and S-06' },
    { t: 22, type: 'anomaly', sensorId: 'S-06', field: 'waterLevel', value: 0.93, message: 'S-06 water level critical' },
    { t: 24, type: 'segment', pipeId: 'P11', state: 'probable_blockage', message: 'Segment P11 elevated to probable blockage' },
    { t: 26, type: 'alert',   severity: 'critical', segment: 'P11', confidence: 88, message: 'High-confidence blockage on 2nd Ave Central — maintenance required' },
    { t: 28, type: 'maintenance', action: 'dispatch', segment: 'P11', message: 'Maintenance team Alpha dispatched to MH-05' },
    { t: 32, type: 'maintenance', action: 'arrived', segment: 'P11', message: 'Team arrived at MH-05 access point' },
    { t: 36, type: 'maintenance', action: 'clearing', segment: 'P11', message: 'Blockage removal in progress' },
    { t: 40, type: 'segment', pipeId: 'P11', state: 'recovery', message: 'Flow resuming on P11' },
    { t: 42, type: 'anomaly', sensorId: 'S-06', field: 'flowRate',   value: 1.2,  message: 'S-06 flow rate recovering' },
    { t: 42, type: 'anomaly', sensorId: 'S-06', field: 'waterLevel', value: 0.45, message: 'S-06 water level normalizing' },
    { t: 44, type: 'segment', pipeId: 'P11', state: 'normal', message: 'Segment P11 recovered — all clear' },
    { t: 44, type: 'segment', pipeId: 'P12', state: 'normal', message: 'Segment P12 recovered — all clear' },
    { t: 45, type: 'status',  message: 'Incident resolved — system normal' },
  ],
};
...
/* ── Upstream / Downstream Lookup for Anomaly Correlation ──── */
// Build adjacency from PIPES so the data engine can traverse the graph
export function buildAdjacency() {
  const downstream = {};   // nodeId → [pipeId]
  const upstream   = {};   // nodeId → [pipeId]
